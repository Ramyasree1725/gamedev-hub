...
"""
Friends API routes for GameDev Hub.
Blueprint providing REST endpoints related to friends.
"""
...
def _id() -> str:
    global _counter
    _counter += 1
    return f"friends_{_counter:06d}_" + "".join(random.choices(string.ascii_lowercase, k=6))

@bp.route("/", methods=["GET"])
def list_items():
    """List all items for friends."""
...
# Domain-specific helpers for friends
class FriendsService:
    """Service class encapsulating friends business logic."""
...
def get_service() -> FriendsService:
