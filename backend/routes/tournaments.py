...
"""
Tournaments API routes for GameDev Hub.
Blueprint providing REST endpoints related to tournaments.
"""
...
def _id() -> str:
    global _counter
    _counter += 1
    return f"tournaments_{_counter:06d}_" + "".join(random.choices(string.ascii_lowercase, k=6))

@bp.route("/", methods=["GET"])
def list_items():
    """List all items for tournaments."""
...
def create_item():
    """Create a new tournaments resource."""
...
# Domain-specific helpers for tournaments
class TournamentsService:
    """Service class encapsulating tournaments business logic."""
...
def get_service() -> TournamentsService:
