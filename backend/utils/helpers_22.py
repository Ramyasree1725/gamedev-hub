...
"""
Utility helpers module 22 for GameDev Hub.
...
def apply_difficulty_multiplier(base_score: int, difficulty: str) -> int:
    ...
    mult = DIFFICULTY_MULTIPLIERS_22.get(difficulty, 1.0)
...
def get_module_info() -> Dict[str, Any]:
    ...
    return {
        ...
        "lookup_size": len(LOOKUP_TABLE_22),
    }
